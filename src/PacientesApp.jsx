  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: '.78rem', fontWeight: 800, color: scoreColor }}>
          {score}
        </span>
      </div>
        ...
        <div style={{
          ...
          <div style={{ padding: '1rem 1.25rem' }}>
            <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 12 }}>
              ...
              <span style={{ fontWeight: 700, color: '#1a3a2a', fontSize: '.85rem' }}>
      ...
      await pacientesQuery(text, {
        ...
        onText: (chunk) => {
          ...
          setConsultas(prev => prev.map(c =>
            c.id === id ? { ...c, response: c.response + chunk } : c
          ))
        },
      })
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            justifyContent: 'center',
            fontSize: '1.2rem',
            boxShadow: '0 4px 12px rgba(45,106,79,.3)',
          }}>🌿</div>
          <div>
          ...
          {hasStarted && (
            <button
              onClick={() => { setConsultas([]); setHasStarted(false); setQuery('') }}
              style={{
                marginLeft: 'auto',
                padding: '.4rem .9rem',
        ...
        {!hasStarted && (
          <div style={{ paddingTop: 48, textAlign: 'center' }}>
            ...
            <p style={{
              ...
              Buscamos en la literatura médica mundial y te explicamos en palabras simples
              qué dice la evidencia sobre tu condición.
            </p>
            <div style={{
      ...
      {hasStarted && !globalLoading && consultas.some(c => !c.loading) && (
        <div style={{
          ...
          borderTop: '1px solid rgba(82,183,136,.15)',
          padding: '12px 16px',
        }}>
          <div style={{
            maxWidth: 720,
